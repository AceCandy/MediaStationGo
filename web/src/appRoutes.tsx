...

  {
    ...
    children: [
      ...
      },
      {
        ...
        navigation: { scope: 'management', label: '系统设置', icon: SlidersHorizontal, to: '/admin/settings', order: 50 },
      },
      {
      ...
      {
        id: 'admin-settings-watching',
        path: 'settings/watching',
        element: <SettingsPage groupKey="watching" />,
      },
    ],
  },
