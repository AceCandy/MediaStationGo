...
export const EMBY_API_ENDPOINTS: readonly EmbyApiEndpoint[] = [
  ...
  },
  {
    ...
    category: '媒体项',
    name: '媒体数量',
    description: '按用户可见文件统计电影、剧集、分集及可播放逻辑项；版本不重复计数。红果短剧 的官方系列剧按聚合身份统计，来源资料表中没有文件的作品不计入。',
    methods: ['GET'],
    path: '/Items/Counts',
  ...
  },
  {
    ...
    category: '媒体项',
    name: '查询媒体项',
    description: '按媒体库、类型、关键字和用户状态查询 Emby 媒体项。根目录媒体库入口遵循管理员设置的排序和显隐。红果短剧与非常规本地 NFO 库保持独立；全局查询合并可见逻辑身份后排序分页，不写入普通资料替身。NFO 使用 nfo- 条目身份及本地剧／季／集层级，人物不按同名关联普通资料。',
    methods: ['GET'],
    path: '/Items',
  ...
  },
  {
    ...
    category: '媒体项',
    name: '媒体项详情',
    description: '读取影片、剧集、季、单集或人物详情。非常规 NFO 条目使用 nfo- 独立身份和本地资料；红果短剧使用 hg-work-/hg-group-/hg-season-/hg-episode-/hg-person- 独立身份。官方聚合仅改变展示层级和季号，hg-group- 后使用官方合集 ID，不编造聚合简介或首播日期。',
    methods: ['GET'],
    path: '/Items/:id',
  ...
  },
  {
    ...
    category: '媒体项',
    name: '最近入库',
    description: '按可见文件的最新入库时间返回媒体项，默认隐藏已播放完成项。指定剧集库时按 Series 展示，红果短剧 库按官方合集展示；全局 Movie/Episode 候选与现有体系合并排序。',
    methods: ['GET'],
    path: '/Items/Latest',
  ...
  },
  {
    ...
    category: '媒体项',
    name: '继续观看',
    description: '返回有进度且尚未播放完成的媒体项。同一剧集只返回最近播放的未完成集；红果短剧及非常规 NFO 的独立观看记录与普通记录按观看时间合并。同一逻辑条目的多版本共用进度并优先最后观看版本。',
    methods: ['GET'],
    path: '/Items/Resume',
  ...
  },
  {
    ...
    category: '媒体项',
    name: '剧集季列表',
    description: '读取指定剧集下的可见季；红果短剧 按官方季号展示，未聚合作品为第一季。未显式指定用户时使用令牌用户。',
    methods: ['GET'],
  ...
  },
  {
    ...
    category: '媒体项',
    name: '剧集单集列表',
    description: '读取指定剧集或季下有可见文件的单集。红果短剧 的 hg-episode- 身份不随官方季号改变；未显式指定用户时使用令牌用户。',
    methods: ['GET'],
  ...
  },
  {
    ...
    category: '播放状态',
    name: '回传播放进度',
    description: '更新用户播放位置、会话和设备状态。启用自动补标前集后，达到已看完标准时补标当前用户同季前面的可见分集，不新增补标集的播放事件。红果短剧和非常规 NFO 分别写入各自的用户状态及会话事件表，不写普通元数据历史。',
    methods: ['POST'],
  ...
  },
  {
    ...
    category: '播放状态',
    name: '设置已播放状态',
    description: 'POST 标记已播放，DELETE 取消已播放。整剧和季递归更新当前用户可见且有文件的单集；剧/季状态按单集汇总，不预先标记缺失或未来入库的集。红果短剧与非常规 NFO 使用各自独立身份；取消已看清除进度但保留收藏和播放事件。',
    methods: ['POST', 'DELETE'],
