...
export const EMBY_API_ENDPOINTS: readonly EmbyApiEndpoint[] = [
  ...
  },
  {
    ...
    category: '媒体项',
    name: '媒体项详情',
    description: '读取影片、剧集、季、单集或人物详情。红果短剧 使用 hg-work-/hg-group-/hg-season-/hg-episode-/hg-person- 独立身份；ProviderIds.红果短剧 保存源 ID。官方聚合仅改变展示层级和季号，hg-group- 后使用官方合集 ID，不编造聚合简介或首播日期。',
    methods: ['GET'],
    path: '/Items/:id',
