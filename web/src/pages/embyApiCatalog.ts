...
export const EMBY_API_ENDPOINTS: readonly EmbyApiEndpoint[] = [
  ...
  },
  {
    ...
    category: '用户与媒体库',
    name: '用户媒体视图',
    description: '返回当前用户可访问的媒体库视图，按管理员设置排序并隐藏关闭展示的入口；不改变搜索与播放权限。',
    methods: ['GET'],
  ...
  },
  {
    ...
    category: '用户与媒体库',
    name: '媒体文件夹',
    description: '返回当前用户可访问的媒体库文件夹，按管理员展示设置排序和过滤，行为与用户视图及根目录 Items 一致。',
    methods: ['GET'],
  ...
  },
  {
    ...
    category: '用户与媒体库',
    name: '虚拟媒体库列表',
    description: '返回当前用户可访问的虚拟媒体库配置数组，遵循管理员统一配置的媒体库顺序和入口显隐。',
    methods: ['GET'],
  ...
  },
  {
    ...
    category: '媒体项',
    name: '查询人物',
    description: '按姓名或人物 ID 查询人物，红果短剧 人物保留独立 hg-person- 身份，只展示拥有可见文件的参演关系。两套人物统一排序分页，不按同名合并。',
    methods: ['GET'],
    path: '/Persons',
    aliases: ['/persons'],
    auth: 'token',
  ...
  },
  {
    ...
    category: '媒体项',
    name: '媒体数量',
    description: '按用户可见文件统计电影、剧集、分集及可播放逻辑项；版本不重复计数。红果短剧 的人工整剧按聚合身份统计，来源资料表中没有文件的作品不计入。',
    methods: ['GET'],
    path: '/Items/Counts',
    aliases: ['/Users/:userId/Items/Counts', '/items/counts', '/users/:userId/items/counts'],
    auth: 'token',
    support: 'implemented',
  ...
  },
  {
    ...
    category: '媒体项',
    name: '查询媒体项',
    description: '按媒体库、类型、关键字和用户状态查询 Emby 媒体项。根目录媒体库入口遵循管理员设置的排序和显隐。红果短剧 库内保持独立；全局查询合并可见逻辑身份后排序分页，不向现有资料表写入红果替身。红果标题按子串匹配，人物以 hg-person- ID 独立识别。',
    methods: ['GET'],
    path: '/Items',
  ...
  },
  {
    ...
    category: '媒体项',
    name: '搜索提示',
    description: '返回播放器全局搜索使用的轻量媒体命中结果，包含有可见文件的 红果短剧 作品及其人物。红果标题使用子串匹配，结果与现有体系统一排名。',
    methods: ['GET'],
    path: '/Search/Hints',
  ...
  },
  {
    ...
    category: '媒体项',
    name: '媒体项详情',
    description: '读取影片、剧集、季、单集或人物详情。红果短剧 使用 hg-work-/hg-group-/hg-season-/hg-episode-/hg-person- 独立身份；ProviderIds.红果短剧 保存源 ID。人工聚合仅改变呈现季号，不编造聚合简介或首播日期。',
    methods: ['GET'],
    path: '/Items/:id',
  ...
  },
  {
    ...
    category: '媒体项',
    name: '最近入库',
    description: '按可见文件的最新入库时间返回媒体项，默认隐藏已播放完成项。指定剧集库时按 Series 展示，红果短剧 库按人工聚合展示；全局 Movie/Episode 候选与现有体系合并排序。',
    methods: ['GET'],
    path: '/Items/Latest',
  ...
  },
  {
    ...
    category: '媒体项',
    name: '继续观看',
    description: '返回有进度且尚未播放完成的媒体项。同一剧集只返回最近播放的未完成集；红果短剧 独立观看记录与现有记录按观看时间合并，同一源集的多版本共用进度并优先最后观看版本。',
    methods: ['GET'],
    path: '/Items/Resume',
  ...
  },
  {
    ...
    category: '媒体项',
    name: '剧集季列表',
    description: '读取指定剧集下的可见季；红果短剧 按人工聚合季号展示，未聚合作品为第一季。未显式指定用户时使用令牌用户。',
    methods: ['GET'],
    path: '/Shows/:id/Seasons',
    aliases: ['/Users/:userId/Shows/:id/Seasons', '/shows/:id/seasons', '/users/:userId/shows/:id/seasons'],
    auth: 'token',
    support: 'implemented',
  ...
  },
  {
    ...
    category: '媒体项',
    name: '剧集单集列表',
    description: '读取指定剧集或季下有可见文件的单集。红果短剧 的 hg-episode- 身份不随人工聚合季号改变；未显式指定用户时使用令牌用户。',
    methods: ['GET'],
    path: '/Shows/:id/Episodes',
    aliases: ['/Users/:userId/Shows/:id/Episodes', '/shows/:id/episodes', '/users/:userId/shows/:id/episodes'],
    auth: 'token',
    support: 'implemented',
    parameters: [
      tokenHeader,
  ...
  },
  {
    ...
    category: '播放状态',
    name: '开始播放',
    description: '记录播放开始并更新会话与设备活动。启用自动补标前集后，达到已看完标准的回报会补标当前用户同季前面的可见分集，不新增补标集的播放事件。',
    methods: ['POST'],
  ...
  },
  {
    ...
    category: '播放状态',
    name: '回传播放进度',
    description: '更新用户播放位置、会话和设备状态。启用自动补标前集后，达到已看完标准时补标当前用户同季前面的可见分集，不新增补标集的播放事件。红果短剧按源作品 ID 与源集号写入独立用户状态、会话事件。',
    methods: ['POST'],
  ...
  },
  {
    ...
    category: '播放状态',
    name: '结束播放',
    description: '保存最终进度并将会话标记为停止。启用自动补标前集后，达到已看完标准时补标当前用户同季前面的可见分集，不新增补标集的播放事件。',
    methods: ['POST'],
  ...
  },
  {
    ...
    category: '播放状态',
    name: '设置收藏状态',
    description: 'POST 收藏电影或整剧，DELETE 取消收藏。不支持季或单集收藏，也不会自动转换成整剧收藏。红果短剧 人工整剧收藏只影响当前用户可见且有文件的源成员。',
    methods: ['POST', 'DELETE'],
  ...
  },
  {
    ...
    category: '播放状态',
    name: '设置已播放状态',
    description: 'POST 标记已播放，DELETE 取消已播放。整剧和季递归更新当前用户可见且有文件的单集；剧/季状态按单集汇总，不预先标记缺失或未来入库的集。红果短剧 使用独立源集身份；取消已看清除进度但保留收藏和播放事件。',
    methods: ['POST', 'DELETE'],
