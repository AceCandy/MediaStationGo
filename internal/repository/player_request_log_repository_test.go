...
func TestPlayerRequestLogRepositoryUsesMonthlyPartitionsAndFilters(t *testing.T) {
	...
	rows := []model.PlayerRequestLog{
		{RequestedAt: time.Date(2026, time.January, 3, 1, 0, 0, 0, time.UTC), Method: "GET", Route: "/emby/Users/:id/Items", Status: 200, DurationMS: 12, IP: "127.0.0.1", Body: `{"ItemId":"item-1"}`, PathParams: map[string][]string{"id": {"user-1"}}, Headers: map[string][]string{}, Query: map[string][]string{}},
