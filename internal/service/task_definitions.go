...
var taskDefinitionSpecs = []taskDefinitionSpec{
	...
	{TaskDefinition: TaskDefinition{Key: TaskDefinitionProbeBackfill, Name: "媒体轨道回填", Description: "遍历并补充缺少完整探测信息的媒体轨道", Trigger: "入库后自动 / 手动", Action: "probe_backfill"}, filter: repository.TaskExecutionFilter{Kind: TaskKindProbe}},
