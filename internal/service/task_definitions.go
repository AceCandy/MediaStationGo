...
var taskDefinitionSpecs = []taskDefinitionSpec{
	...
	{TaskDefinition: TaskDefinition{Key: TaskDefinitionCatalogScrape, Name: "作品资料补全", Description: "补全发现页和已入库作品的资料、图片与季集信息", Trigger: "事件触发"}, filter: repository.TaskExecutionFilter{Kind: TaskKindScrape, NamePrefix: "发现目录刮削："}},
