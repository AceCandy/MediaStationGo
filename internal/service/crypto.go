...
//
// Sensitive fields (third-party API keys and service credentials) are
// stored in PostgreSQL. We encrypt them with AES-256-GCM keyed off the JWT
// secret so a database leak alone is not enough to recover the
